  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 py-20 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 max-w-md mx-auto grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:max-w-4xl">
            <Link href="/explore" className="btn bg-white text-primary-800 hover:bg-gray-100">
              <MapIcon className="h-5 w-5 mr-2" />
              Explore Knowledge Graph
            </Link>
            <Link href="/search" className="btn bg-white text-primary-800 hover:bg-gray-100">
              <MagnifyingGlassIcon className="h-5 w-5 mr-2" />
              Advanced Search
            </Link>
            <Link href="/visualize" className="btn bg-white text-primary-800 hover:bg-gray-100">
              <ChartBarIcon className="h-5 w-5 mr-2" />
              Visualize Data
            </Link>
            <Link href="/dashboard" className="btn bg-white text-primary-800 hover:bg-gray-100">
